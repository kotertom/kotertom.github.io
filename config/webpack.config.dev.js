...
module.exports = {
            ...
            use: [
              {
                ...
                loader: 'typings-for-css-modules-loader?modules&namedExport&camelCase&localIdentName=[pat' +
  ...
  plugins: [
    ...
    // compilation
    new ForkTsCheckerWebpackPlugin({async: false, watch: paths.appSrc, tsconfig: paths.appTsConfig, tslint: paths.appTsLint})
  ],
