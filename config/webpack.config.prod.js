...
module.exports = {
  ...
  plugins: [
    ...
    new UglifyJsPlugin({
      uglifyOptions: {
        parse: {
          // we want uglify-js to parse ecma 8 code. However we want it to output ecma 5
          // compliant code, to avoid issues with older browsers, this is whey we put
          // `ecma: 5` to the compress and output section
    ...
    // compilation
    new ForkTsCheckerWebpackPlugin({async: false, tsconfig: paths.appTsProdConfig, tslint: paths.appTsLint})
  ],
